...
namespace tema7
{
    public class Utils
    {
        ...
        public static Polynomial MPIMultiply(Polynomial poly1, Polynomial poly2, int begin, int end)
        {
            Polynomial result;
        ...
        public static Polynomial AsynchronousKaratsubaMultiply(Polynomial poly1, Polynomial poly2)
        {
            Polynomial result = new Polynomial(poly1.Degree + poly2.Degree);
            result.Coefficients = AsynchronousKaratsubaMultiplyRecursive(poly1.Coefficients, poly2.Coefficients);
