...
AS
    EXEC addEmployee2 'Candet Andrei', 'candetandrei@gmail.com', '2131231232', '2020-06-05', '0740000000', 'Cool guy', 1 -- run twice, error on 3rd field (unique field constrain)
    EXEC addTask2 'Test task', 'brief', 'repo dir', 29007, '2020-06-06', '2020-06-06', 'status', 1
    EXEC addAssign2 'Candet Andrei', 'Test task'
GO
...
AS
    EXEC addEmployee2 'Candet Andrei', 'candetandrei@gmail.com', '321231233', '2020-06-05', '0740000000', 'Cool guy', 1
    EXEC addTask2 'Test task', 'brief', 'repo dir', 29007, '2020-06-06', '2020-06-06', 'status', 1
    EXEC addAssign2 'Candet Andrei', 'Test task'
GO