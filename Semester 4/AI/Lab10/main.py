...
from domain.FuzzyDescription import FuzzyDescription
from domain.FuzzyRule import FuzzyRule
...
if __name__ == '__main__':
    ...
    rules.append(FuzzyRule({'texture': 'verySoft', 'capacity': 'small'}, {'type': 'delicate'}))
    rules.append(FuzzyRule({'texture': 'verySoft', 'capacity': 'medium'}, {'type': 'easy'}))
    rules.append(FuzzyRule({'texture': 'verySoft', 'capacity': 'high'}, {'type': 'normal'}))

    rules.append(FuzzyRule({'texture': 'soft', 'capacity': 'small'}, {'type': 'easy'}))
    rules.append(FuzzyRule({'texture': 'soft', 'capacity': 'medium'}, {'type': 'normal'}))
    rules.append(FuzzyRule({'texture': 'soft', 'capacity': 'high'}, {'type': 'normal'}))

    rules.append(FuzzyRule({'texture': 'normal', 'capacity': 'small'}, {'type': 'easy'}))
    rules.append(FuzzyRule({'texture': 'normal', 'capacity': 'medium'}, {'type': 'normal'}))
    rules.append(FuzzyRule({'texture': 'normal', 'capacity': 'high'}, {'type': 'intense'}))

    rules.append(FuzzyRule({'texture': 'resistant', 'capacity': 'small'}, {'type': 'easy'}))
    rules.append(FuzzyRule({'texture': 'resistant', 'capacity': 'medium'}, {'type': 'normal'}))
    rules.append(FuzzyRule({'texture': 'resistant', 'capacity': 'high'}, {'type': 'intense'}))
